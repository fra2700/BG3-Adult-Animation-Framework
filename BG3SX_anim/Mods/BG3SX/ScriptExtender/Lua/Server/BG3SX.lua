...
function OnSessionLoaded()
    ...
    Ext.Osiris.RegisterListener("LevelGameplayStarted", 2, "after", function(_, _)
        ...
        --Initialize the ModVar lists
        local var = Ext.Vars.GetModVariables("df8b9877-5662-4411-9d08-9ee2ec4d8d9e")
        var.BG3SX_StartSexSpells = StartSexSpells
        var.BG3SX_SexAnimations = SexAnimations
    end)
    ...
    Ext.Osiris.RegisterListener("UsingSpellOnTarget", 6, "after", function(caster, target, spell, _, _, _)
        ...
        local var = Ext.Vars.GetModVariables("df8b9877-5662-4411-9d08-9ee2ec4d8d9e")
        local startSexSpells = var.BG3SX_StartSexSpells

        for _, table in ipairs(startSexSpells) do
            if table.AnimName == spell then

                --_D(var.BG3SX_StartSexSpells)
                --_D(var.BG3SX_SexAnimations)
